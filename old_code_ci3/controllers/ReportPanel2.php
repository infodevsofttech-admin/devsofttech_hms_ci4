...
EOD;
	...
	$doc_name_id,$emp_name_id,$paymode_id,$order_1,$order_2,$group_by)
	{
		...
		o.P_name ,
		p_code ,
		Date_Format(o.apointment_date,'%d-%m-%Y') as 'App_Date',
		o.doc_name ,
		if(o.insurance_id>1,'Org.','Direct') as 'Type',
		m.mode_desc as 'PayMode',
...
EOD;
	...
	public function report_total_payment_app_show($opd_date_range,$emp_name_id,$paymode_id,$order_1)
	{
		...
		if($paymode_id>0)
		{
			if($paymode_id==1)
				{
					$sql_where.=" and p.payment_mode in (1,3) ";
				}else{
					$sql_where.=" and p.payment_mode = '".$paymode_id."'";
				}
		}
...
EOD;
	...
	public function report_emp_total($opd_date_range,$emp_name_id,$paymode_id,$order_1)
		{
