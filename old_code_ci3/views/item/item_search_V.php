<section class="content-header">
    <h1>
        OPD Charges 
        <small><button onclick="load_form_div('/item/search_itemtype','maindiv');" type="button" class="btn btn-primary">Go for Charges Group</button></small>
    </h1>
</section>
<?php echo form_open('', array('role'=>'form','class'=>'form1')); ?>
 <section class="content">
      <div class="row">
        ...
        <div class="col-md-2">
        <div class="form-group">
            <button onclick="load_form_div('/item/AddRecord','maindiv','New Itam Add');" type="button" class="btn btn-primary">Add New Charge</button>
        </div>
        </div>
    </div>
    <div class="row">
...
<div class="box-body">
<div id="search_div">
	<a href="/Item/search_print/1" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
	<a href="/Item/item_all_print?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print ALL</a>
  <br/><br/>
  <table id="datashow1" class="table table-bordered table-striped TableData">
    ...
    <tr>
	  ...
	  data-testid="<?=$row->id ?>" data-testname="<?=$row->group_desc ?>">Edit It....</button></td>
    </tr>
    <?php } ?>
    </tbody>
    <tfoot>
    ...
    $(document).ready(function () {
        $('#datashow1').dataTable();
    		...
    		$("#itype_idv").change(function(){
    			load_form_div('/Item/search_adv/'+$('#itype_idv').val(),'search_div');
    			});
          ...
          var csrf_value=$('input[name=<?=$this->security->get_csrf_token_name()?>]').val();
      		...
      		$.post('/index.php/item/item_record/'+testid,{ "test_id": testid,'<?=$this->security->get_csrf_token_name()?>':csrf_value }, function(data){
