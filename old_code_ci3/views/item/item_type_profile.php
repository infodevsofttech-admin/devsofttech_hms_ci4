<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="javascript:load_form_div('/item/search_itemtype','maindiv','OPD Charge Master');"><i class="fa fa-dashboard"></i>Charges Group List</a></li>
    ...
    $(document).ready(function(){
        $('#btn_update').click(function(){
			$.post('/index.php/item/UpdateItemTypeRecord', $('form.form1').serialize(), function(data){
                if(data.update==0)
                {
					notify('Success',data.error_text);
                }else
                {
