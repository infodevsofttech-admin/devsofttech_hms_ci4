...
<table  cellspacing="5" style="width: 100%;vertical-align: top;padding: 15px;">
    <tr>
        <td style="width: 50%;vertical-align: top;border-right: 1px solid #ddd;">
            <!--- Head Start  -->
            <table   style="font-size: 10px;width:100%;border-style: inset;" >
                <tr>
...
<table  style="width: 100%;vertical-align: top;padding: 1px;font-size: 11px;">
    <tr>
        <td style="width: 50%;vertical-align: top;border-right: 1px solid #ddd;" >
            <!---Left Copy Start  -->
            <table style="width: 500px;vertical-align: top;padding: 1px;">
                <tr>
            ...
            <table  style="width:500px;vertical-align: top;padding: 1px;" >
                ...
                <?php
                    ...
                    $content.='<tr>
                        ...
                        <th></th>
                        <th></th>
                        <th align="right"><i class="fa fa-inr"></i>-'.$invoice_master[0]->discount_amount.'</th>
