	...
	<div class="row" >
		<div class="col-xs-3">
			<ul class="nav  nav-tabs tabs-left">
				<li><a data-toggle="tab" href="#menu2" >Presenting Complaints with Duration and Reason for Admission</a></li>
				...
				<li><a data-toggle="tab" href="#discharge_status">Discharge Date / Operation / delivery if any </a></li>
				<li><a data-toggle="tab" href="#menu3" >Final Diagnosis</a></li>
				<li><a data-toggle="tab" href="#menu4" >Summary of key investigtions during Hospitalization</a></li>
				...
				<li><a data-toggle="tab" href="#menu6" >Discharge Medications</a></li>
				<li><a data-toggle="tab" href="#menu7" >Discharge Instructions (diet, activity, discharged to home/nursing facility, etc)</a></li>
		...
		<div class="tab-content">
			<div id="discharge_status" class="tab-pane fade in">
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input id="dis_date" name="dis_date" class="form-control pull-right datepicker" type="text" 
					...
					<div class="col-md-3">
						<div class="form-group">
						  ...
						  <div class="input-group">
							<input id="dis_time" name="dis_time" class="form-control timepicker" type="text" value="<?=$ipd_master[0]->discharge_time?>" >
							<div  class="input-group-addon">
					...
					<div class="col-md-3">
						...
						<?php foreach($ipd_discharge_status as $row){ ?>
							<option value="<?=$row->id?>" <?=combo_checked($row->id,$ipd_master[0]->discarge_patient_status)?>  ><?=$row->status_desc?></option>
						<?php }  ?>
						</select>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-2">
						<div class="form-group">
							...
							<div class="radio">
								<label>
								  <input name="optionsRadios_issurgery" id="options_issurgery1" value="1" <?=radio_checked("1",$ipd_master[0]->issurgery)?> type="radio" >
								  Yes
								</label>
								<label>
									<input name="optionsRadios_issurgery" id="options_issurgery2" value="0" <?=radio_checked("0",$ipd_master[0]->issurgery)?> type="radio" >
									No.
								</label>
							</div>
						</div>
					...
					<div class="col-md-6"> 
						<div class="form-group">
							<div class="ui-widget">
								<label for="tags">Specify nature of surgery/ procedure  </label>
								<input class="form-control input-sm" name="input_surgery_name" id="input_surgery_name" placeholder="" type="text" 
								value="<?=$ipd_master[0]->surgery_name?>" >
							</div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input id="dis_surgery_date" name="dis_surgery_date" class="form-control pull-right datepicker" type="text" data-inputmask="'alias': 'dd/mm/yyyy'" 
								data-mask="" 
								value="<?php echo ($ipd_master[0]->surgery_date?MysqlDate_to_str($ipd_master[0]->surgery_date):date('d/m/Y')); ?>"  />
							</div>
						</div>
					</div>
					<div class="col-md-3">
						...
						<label>Save Data</label>
							<button type="button" id="btn_surgery_request" name="btn_surgery_request" class="btn btn-primary form-control">Update Surgery Record</button>
						</div>
						<div class="jsError"></div>
					</div>
				</div>
				...
				<div class="row">
					<hr/><h3>If Delivered, date and time of delivery</h3>
				</div>
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="radio">
								<label>
								  <input name="optionsRadios_isdelivery" id="options_isdelivery1" value="1" <?=radio_checked("1",$ipd_master[0]->isdelivery)?> type="radio" >
								  Yes
								</label>
								<label>
									<input name="optionsRadios_isdelivery" id="options_isdelivery2" value="0" <?=radio_checked("0",$ipd_master[0]->isdelivery)?> type="radio" >
									No
								</label>
							</div>
						</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<input id="delivery_date" name="delivery_date" class="form-control pull-right datepicker" 
					...
					<div class="col-md-3">
						<div class="form-group">
						  ...
						  <div class="input-group">
							<input id="delivery_time" name="delivery_time" class="form-control timepicker" type="text" value="<?=$ipd_master[0]->delivery_time?>" >
							<div  class="input-group-addon">
							  <i class="fa fa-clock-o"></i>
							</div>
						  </div>
					...
					<div class="col-md-3">
						...
						<label>Sex of baby:</label>
							<select id="delivery_sex_of_baby" name="delivery_sex_of_baby" class="form-control" >
								<option value="" <?=combo_checked("",$ipd_master[0]->delivery_sex_of_baby)?> >None</option>
								<option value="Girl" <?=combo_checked("Girl",$ipd_master[0]->delivery_sex_of_baby)?> >Girl</option>
								<option value="Boy" <?=combo_checked("Boy",$ipd_master[0]->delivery_sex_of_baby)?> >Boy</option>
							</select>
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
						<label>Save Data</label>
							<button type="button" id="btn_update_delivery" name="btn_update_delivery" class="btn btn-primary form-control">Update Delivery Record</button>
						</div>
						<div class="jsError"></div>
					</div>
				</div>
				...
				<div class="row">
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<input type="hidden" value="<?=$ipd_master[0]->id ?>" id="gen_exam_ipd_id" name="gen_exam_ipd_id" />
							<div class="row">
								...
								<div class="col-md-2"> 
									<div class="form-group">
										<div class="ui-widget">
											...
											<input class="form-control input-sm" name="input_g_exam_<?=$row->id?>"  id="input_g_exam_<?=$row->id?>" type="text" value="<?=$row->rdata_text?>" autocomplete="on" >
										</div>
									</div>
								</div>
								<?php } ?>
							...
							<div class="row">
								<div class="col-md-2">
									<button type="button" class="btn btn-primary" id="btn_g_exam_save" onclick="save_gen_Exam()" >Save</button>
								</div>
							</div>
							<?php echo form_close(); ?>
						</div>
					...
					<div class="box box-info collapsed-box">
						<div class="box-header">
						  ...
						  <div class="pull-right box-tools">
							<button type="button" class="btn btn-warning btn-sm" onclick="save_Sys_Exam('<?=$ipd_master[0]->id ?>','<?=$row->id?>')"   data-toggle="tooltip"
									title="Save Data">
						...
						<textarea id="editor_Sys_Exam_<?=$row->id?>" name="editor_Sys_Exam_<?=$row->id?>"  class="editor"  rows="10" cols="100"><?=$row->rdata?></textarea>
						<script>
						  $(function () {
			...
			<div id="menu1" class="tab-pane fade">
				<div class="row">
					<div class="box box-primary">
						<div class="box-header with-border">
							<div class="col-md-8">
								<h3 class="box-title">CLINICAL INVESTIGATION REPORTS</h3>
							</div>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-12"> 
									<div class="box box-info collapsed-box">
										<div class="box-header">
										  <h3 class="box-title">Clinical Investgation Done List
											<small>Blood Hb,Blood Sugar,Renal Function,Serum Bilirubin,Urine Test</small>
										  </h3>
										  <!-- tools box -->
										  <div class="pull-right box-tools">
											<button type="button" class="btn btn-info btn-sm" data-widget="collapse" data-toggle="tooltip"
										...
										<div class="box-body pad">
											...
											<div class="checkbox">
											  <label>
												<input type="checkbox" class="chk" name="invprofiles_<?=$i?>" value="<?=$row->sDate?>" <?=$row->chked ?> >
				...
				<div class="row">
					<div class="box box-info collapsed-box">
						...
						?>
							<textarea id="editor_Other_examinations" name="editor_Other_examinations"  class="editor"  rows="10" cols="80"><?=$content?></textarea>
							<script>
							  $(function () {
			...
			<div id="menu2" class="tab-pane fade in active">
					...
					<div class="col-md-12">
						<div class="row">
							<div class="box box-primary">
								<div class="box-header with-border">
									<div class="col-md-8">
										<h3 class="box-title">Presenting Complaints with Duration and Reason for Admission</h3>
									</div>
								</div>
								<div class="box-body">
									<div class="row" id="complaints_table">
										<div class="col-md-12" >
											...
											<?php if(count($ipd_discharge_complaint)>0) { echo '<tr><th>Complaint Name</th><td>Remarks</th><th></th><th></th></tr>'; } ?>
										...
										<div class="col-md-6"> 
											<div class="form-group">
												<div class="ui-widget">
													...
													<input class="form-control input-sm" name="input_complaints" id="input_complaints" placeholder="Like FEVER , COUGH" type="text" autocomplete="on" >
													<input type="hidden" id="input_complaints_value" name="input_complaints_value" value="0" >
												</div>
											</div>
										</div>
										<div class="col-md-5"> 
											<div class="form-group">
												<div class="ui-widget">
													...
													<input class="form-control input-sm" name="input_complaints_remarks" id="input_complaints_remarks" placeholder="" type="text" >
												</div>
											</div>
										</div>
										<div class="col-md-1"> 
											<div class="form-group">
												<div class="ui-widget">
													...
													<button type="button" id="btn_complaints" class="btn btn-primary">+ADD</button>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="row">
					<div class="box box-info collapsed-box">
						...
						?>
							<textarea id="editor_Other_Complaints" name="editor_Other_Complaints"  class="editor"  rows="10" cols="80"><?=$content?></textarea>
				...
				<div class="row">
					<div class="col-md-2">
						<button type="button" class="btn btn-primary"  onclick="save_Complaints()" >Save</button>
					</div>
				</div>
			</div>
			<div id="menu3" class="tab-pane fade">
							...
							<div class="box box-primary">
								...
								<div class="box-body">
									<div class="row" id="diagnosis_table">
										<div class="col-md-12" >
											<table class="table table-condensed" >
											<?php if(count($ipd_discharge_diagnosis)>0) { echo '<tr><th>Diagnosis </th><td>Remarks</th><th></th><th></th></tr>'; } ?>
									...
									<div class="row">
										<div class="col-md-6"> 
											<div class="form-group">
												<div class="ui-widget">
													<label for="tags">Complaints/ Reported Problems: </label>
													<input class="form-control input-sm" name="input_diagnosis" id="input_diagnosis" placeholder="Like FEVER , COUGH" type="text" >
													<input type="hidden" id="input_diagnosis_value" name="input_diagnosis_value" value="0" >
												</div>
											</div>
										</div>
										<div class="col-md-5"> 
											<div class="form-group">
												<div class="ui-widget">
													...
													<input class="form-control input-sm" name="input_diagnosis_remarks" id="input_diagnosis_remarks" placeholder="" type="text" >
												</div>
											</div>
										</div>
										<div class="col-md-1"> 
											<div class="form-group">
												<div class="ui-widget">
													<label for="tags"> </label>
													<button type="button" id="btn_diagnosis" class="btn btn-primary">+ADD</button>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="row">
					<div class="box box-info collapsed-box">
						...
						<div class="box-body pad">
							...
							?>
							<textarea id="editor_Other_Diagnosis" name="editor_Other_Diagnosis"  class="editor"  rows="10" cols="80"><?=$content?></textarea>
							<script>
							  $(function () {
								CKEDITOR.replace('editor_Other_Diagnosis')
							  })
							</script>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-2">
						<button type="button" class="btn btn-primary"  onclick="save_Diagnosis()" >Save</button>
					</div>
				</div>
			</div>
			<div id="menu4" class="tab-pane fade">
				<div class="row">
					<div class="box box-info collapsed-box">
						<div class="box-header">
						  <h3 class="box-title">Summary of key investigtions during Hospitalization
							<small></small>
						  </h3>
						  <div class="pull-right box-tools">
							<button type="button" class="btn btn-info btn-sm" data-widget="collapse" data-toggle="tooltip"
						...
						?>
							<textarea id="editor_investigtions_Hospitalization" name="editor_investigtions_Hospitalization"  class="editor"  rows="10" cols="80"><?=$content?></textarea>
							<script>
							  $(function () {
				...
				<div class="row">
					<div class="col-md-2">
						<button type="button" class="btn btn-primary"  onclick="save_Hospial_investigtions()" >Save</button>
					</div>
				</div>
			</div>
			<div id="menu5" class="tab-pane fade">
							...
							<div class="box box-primary">
								...
								<div class="box-body">
									<div class="row" id="course_table">
										<div class="col-md-12" >
											<table class="table table-condensed" >
											<?php if(count($ipd_discharge_course)>0) { echo '<tr><th>Course </th><td>Remarks</th><th></th><th></th></tr>'; } ?>
										...
										<div class="col-md-6"> 
											<div class="form-group">
												<div class="ui-widget">
													...
													<input class="form-control input-sm" name="input_course" id="input_course" placeholder="Like FEVER , COUGH" type="text" >
													<input type="hidden" id="input_course_value" name="input_course_value" value="0" >
												</div>
											</div>
										</div>
										<div class="col-md-5"> 
											<div class="form-group">
												<div class="ui-widget">
													<label for="tags">Remarks / Comments: </label>
													<input class="form-control input-sm" name="input_course_remarks" id="input_course_remarks" placeholder="" type="text" >
												</div>
											</div>
										</div>
										<div class="col-md-1"> 
											<div class="form-group">
												<div class="ui-widget">
													<label for="tags"> </label>
													<button type="button" id="btn_course" class="btn btn-primary">+ADD</button>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="row">
					<div class="box box-info collapsed-box">
						...
						if(count($ipd_discharge_course_remark)>0){
							...
							if(strlen($content)<1)
							{
								$content="Conservative with antibiotics,antiepileptics,analgesic,antipyretics,PPI,IV Fluids & another supportive treatments.";
							}
						}
						?>
							<textarea id="editor_Course_hospital" name="editor_Course_hospital"  class="editor"  rows="10" cols="80"><?=$content?></textarea>
							<script>
							  $(function () {
				...
				<div class="row">
					<div class="col-md-2">
						<button type="button" class="btn btn-primary"  onclick="save_course()" >Save</button>
					</div>
				</div>
			</div>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="row" id="drug_table">
							<div class="col-md-12" >
								<table class="table table-condensed" >
								<?php if(count($ipd_discharge_drug)>0) { echo '<tr><th>Prescribed</th><td>Dosage</th><td>Remarks</th><th></th><th></th></tr>'; } ?>
									<?php foreach($ipd_discharge_drug as $row) { ?>
									<tr>
										<td><?=$row->drug_name?></td>
										<td><?=$row->drug_dose?></td>
										<td><?=$row->drug_day?></td>
						...
						<div class="row">
							<div class="col-md-5"> 
								<div class="form-group">
									<div class="ui-widget">
										...
										<input class="form-control input-sm" name="input_drug" id="input_drug" placeholder="Like ACIVIR IV INJ 10ML , ACTIBILE 600TAB" type="text" >
									</div>
								</div>
							</div>
							<div class="col-md-3"> 
								<div class="form-group">
									<div class="ui-widget">
										<label for="tags">Doage  </label>
										<input class="form-control input-sm" name="input_dosage" id="input_dosage" placeholder="" type="text" >
									</div>
								</div>
							</div>
							<div class="col-md-3"> 
								<div class="form-group">
									<div class="ui-widget">
										<label for="tags">No. of Days </label>
										<input class="form-control input-sm" name="input_days" id="input_days" placeholder="" type="text" autocomplete="on" >
									</div>
								</div>
							</div>
							...
							<div class="col-md-1"> 
								<div class="form-group">
									<div class="ui-widget">
										<label for="tags"> </label>
										<button type="button" id="btn_drug" class="btn btn-primary">+ADD</button>
									</div>
								</div>
							</div>
						</div>
			...
			<div id="menu7" class="tab-pane fade">
				<div class="row">
					<div class="box box-info collapsed-box">
						<div class="box-header">
						  <h3 class="box-title">FOOD DRUG INTERACTION
							<small></small>
						  </h3>
						  <div class="pull-right box-tools">
							<button type="button" class="btn btn-info btn-sm" data-widget="collapse" data-toggle="tooltip"
						...
						?>
							<textarea id="editor_FOOD_DRUG_INTERACTION_list" name="editor_FOOD_DRUG_INTERACTION_list" class="editor" rows="10" cols="80"><?=$content?></textarea>
							
						<br/>
						<button type="button" class="btn btn-primary"  onclick="save_FOOD_DRUG_INTERACTION()" >Save</button>
						</div>
					</div>
				</div>
				<?php  
						...
						if(count($ipd_discharge_instructions)>0){
							...
							{
								$content="
								Review after 5 days / as and when required";
							}
							$footer_content=$ipd_discharge_instructions[0]->footer_text;
							if(strlen($footer_content)<1)
							{
								$footer_content='<table border="0" cellpadding="1" cellspacing="1" width:"100%">
								<tbody>
									<tr>
							...
							$footer_content.='<table border="0" cellpadding="1" cellspacing="1" width:"100%">
								<tbody>	
									<tr>
										...
										<td colspan="3" style="text-align:center; vertical-align:middle">
											Discharge Summary,Original Reports Received by 
										</td>
				...
				<div class="row">
					<div class="box box-info collapsed-box">
						<div class="box-header">
						  <h3 class="box-title">Discharge Instructions
							<small></small>
						  </h3>
						  <div class="pull-right box-tools">
							<button type="button" class="btn btn-info btn-sm" data-widget="collapse" data-toggle="tooltip"
						...
						<div class="box-body pad">
						<textarea id="editor_Discharge_Instructions" name="editor_Discharge_Instructions" class="editor" rows="10" cols="80"><?=$content?></textarea>
							<script>
							  $(function () {
						...
						<br />
						<button type="button" class="btn btn-primary"  onclick="save_Instructions()" >Save</button>
				...
				<div class="row">
					<div class="box box-info collapsed-box">
						...
						<div class="box-body pad">
							<textarea id="editor_Discharge_Footer" name="editor_Discharge_Footer" class="editor" rows="10" cols="80"><?=$footer_content?></textarea>
							<script>
							  $(function () {
						...
						<br />
						<button type="button" class="btn btn-primary"  onclick="save_Discharge_Footer()" >Save</button>
				...
				<div class="row">
					<div class="box box-info collapsed-box">
						...
						<?php } ?>
						<button type="button" class="btn btn-primary"  onclick="save_footer_banner()" >Save</button>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<input type="hidden" value="<?=$ipd_master[0]->id ?>" id="dis_exam_ipd_id" name="dis_exam_ipd_id" />
							<div class="row">
								...
								<div class="col-md-2"> 
									<div class="form-group">
										<div class="ui-widget">
											<label for="tags"><?=$row->col_description?>: </label>
											<input class="form-control input-sm" name="input_d_exam_<?=$row->id?>"  id="input_d_exam_<?=$row->id?>" type="text" value="<?=$row->rdata_text?>" autocomplete="on">
										</div>
									</div>
								</div>
								<?php } ?>
							...
							<div class="row">
								<div class="col-md-2">
									<button type="button" class="btn btn-primary" id="btn_d_exam_save" onclick="save_discharge_Exam()" >Save</button>
								</div>
							</div>
							<?php echo form_close(); ?>
						</div>
...
<script>
	...
	function save_Diagnosis(){
		var ipd_id = $('#ipd_id').val();
		var editor_Sys_Exam=CKEDITOR.instances['editor_Other_Diagnosis'].getData();
   ...
   $(document).ready(function(){
	   ...
	   $("#input_course").autocomplete({
			...
			$.getJSON( "Ipd_discharge/get_hospital_course_master", request, function( data, status, xhr ) {
        ...
        autofocus: true,
		select: function( event, ui ) {
			$("#input_surgery").val(ui.item.value);
			$("#input_surgery_value").val(ui.item.complaints_no);
			}		      	
		});
		...
		$("#input_drug").autocomplete({
		    source: function( request, response ) {
			var term = request.term;
			if ( term in cacheDrug ) {
			  response( cacheDrug[ term ] );
			  return;
			}
			$.getJSON( "Ipd_discharge/get_medical", request, function( data, status, xhr ) {
			  cacheDrug[ term ] = data;
			  response( data );
			});
		},
		...
		$("#input_dosage").autocomplete({
		    source: function( request, response ) {
			var term = request.term;
			if ( term in cacheDosage ) {
			  response( cacheDosage[ term ] );
			  return;
			}
			$.getJSON( "Ipd_discharge/get_drug_timing", request, function( data, status, xhr ) {
			  cacheDosage[ term ] = data;
			  response( data );
			});
		},
        minLength: 1,
        autofocus: true,
		select: function( event, ui ) {
			$("#input_dosage").val(ui.item.label);
		...
		$('#btn_drug').click(function(){
			var ipd_id = $('#ipd_id').val();
			var input_drug = $('#input_drug').val();
			
			var input_days = $('#input_days').val();
		...
		$('#btn_update_delivery').click(function(){
			...
			$.post('/index.php/Ipd/update_delivery', 
				{
					"ipd_id": $('#ipd_id').val(),
