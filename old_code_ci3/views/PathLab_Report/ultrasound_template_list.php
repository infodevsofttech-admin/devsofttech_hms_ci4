...
<div class="row">
	<div class="col-md-6">
		...
		<div class="box-header">
			...
			<div class="col-md-2"><button onclick="load_form_div('/Lab_Admin/reportedit_ultrasound_load/0','test_div');" type="button" class="btn btn-primary">Add New Report</button></div>
		...
		<div class="box-body" style="height:500px;overflow-y:auto;">
		  <table id="report_list" class="table table-bordered table-striped TableData">
			...
			<tr>
			  ...
			  <td>
				  <button onclick="load_form_div('/Lab_Admin/reportedit_ultrasound_load/<?=$labReport_master[$i]->id ?>','test_div');" type="button" class="btn btn-primary">Edit</button>
			  </td>
			</tr>
			<?php } ?>
			</tbody>
