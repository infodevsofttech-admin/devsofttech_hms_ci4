...
<hr/>
<table  cellspacing="0"  style="font-size: 12px;width:100%;border-style:solid;vertical-align: top;" >
			<tr>
			...
			for($i=0;$i<Count($ipd_invoice_item);$i++)
				{ 
					...
					echo '<tr>';
					echo '<td>'.$srno.'</td>';
					echo '<td>'.$ipd_invoice_item[$i]->item_name.'<br/><i>'.$ipd_invoice_item[$i]->comment.'</i></td>';
					echo '<td></td>';
