	...
	<div class="col-md-3">
		<div class="form-group">
		  ...
		  <div class="input-group">
			<input id="dis_time" name="dis_time" class="form-control" type="text" value="<?=$ipd_info[0]->discharge_time?>" required >
			<div  class="input-group-addon">
	...
	<div class="col-md-2">
		...
		<label>Update Discharge Status</label>
			<?php if($this->ion_auth->in_group('IPDDischarge')){
				...
				<button type="button" id="btn_update" name="btn_update" class="btn btn-primary form-control">Update Discharge</button>
			<?php }else{  ?>
...
$(document).ready(function(){
        $('#btn_update').click(function(){
			...
			if(dis_time.trim()=="")
			{
				alert("Please Update Discharge Time.");
				return false;
			}
