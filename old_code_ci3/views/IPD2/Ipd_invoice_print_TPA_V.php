...
<table  cellspacing="2"  style="font-size: 12px;width:100%;border-style: inset;" >
			...
			<tr>
				...
				<td colspan="2"><b>Payable By TPA : </b></td>
				<td></th>
				<td></td>
				<td align="right" style="text-align:right"><b><?=$ipdmaster[0]->payable_by_tpa ?></b></td>
			</tr>
			<?php }  ?>
			...
			<tr>
				<th colspan="2">
					...
					<br>
					<br>
					<br>Patient / Relative  Signature</th>
				<th colspan="4" align="right" style="text-align:right">
					<br>
					<br>
					<br>
					<br>
					<br>Authorized Signatory</th>
			</tr>
		</table>