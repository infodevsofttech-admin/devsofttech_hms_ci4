                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="input_loc_name" placeholder="Location Name" type="text" required="true" />
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label>Location Desc</label>
                                <input class="form-control" name="input_loc_desc" placeholder="Location Description" type="text" required="true" />
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="hid_location_id" name="hid_location_id" value="0" />
                </div>
                <!-- /.box-body -->
