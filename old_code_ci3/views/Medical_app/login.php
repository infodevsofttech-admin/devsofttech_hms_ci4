...
<?php 
  ...
  echo form_open('Medical_app/login/'.$user_id,$attributes); ?>
      <div class="row">
           <h2 style="text-align: center;">Welcome</h2>
           <h1 style="text-align: center;"> 
            <span class="text-danger">User : <?php echo ucfirst($user_data_profile[0]->first_name); ?> <?php echo ucfirst($user_data_profile[0]->last_name); ?></span>
           </h1>
           <h2 style="text-align: center;"> 
            <span class="text-warning"><?php echo $user_data_profile[0]->username; ?></span>
           </h2>
      </div>
      <div class="row">
        <hr />
...
<script>
    $(document).ready(function(){
      $('#myform').on('submit', function(form){
            ...
            $.post('/Medical_app/login/<?=$user_id?>', form_array, function(data){
