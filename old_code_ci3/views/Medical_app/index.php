 ...
 <nav class="navbar navbar-light " style="background-color: #e3f2fd;">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="javascript:load_form('/Medical_app/load_dash');">Home</a>
    </div>
  </div>
</nav> 
...
<?php
      ...
      <div class="main_menu">         
          <a href="javascript:load_form('/Medical_app/select_user_login');" class="btn btn-app ">
