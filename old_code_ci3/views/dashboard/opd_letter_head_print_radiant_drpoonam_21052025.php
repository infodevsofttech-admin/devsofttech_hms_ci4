...
<table  cellspacing="0"  style="font-size: 12px;width:100%;border-style: inset;" >
    <tr>
        ...
        <td style="width: 400px;vertical-align: top;text-align: center;">
            <p style="font-size:28px;font-weight: bold;color:darkblue;" >RADIANT FERTILITY AND IVF CENTRE</p>
            <p style="font-size: 14px;font-weight: bold;color:black;" >A Unit of Radiant Hospital</p>
        </td>
