...
<table  cellspacing="0"  style="font-size: 10px;width:100%;border-style: inset;" >
    <tr>
        ...
        <td style="width: 400px;vertical-align: top;text-align: left;">
            ...
            <p align="center" style="font-size: 14px;" >An ISO Certified 9001 : 2015 <br/>
            NABH (Fully Accredited) Hospital
            </p>
...
<div class="RxPlace">
        <?php
            ...
            if(strlen($morbidities)>0){
                echo 'Co-Morbidities : '.$morbidities;
                echo '<br/>';
            }

            if(strlen($Addiction)>0){
                echo 'Addiction : '.$Addiction;
                echo '<br/>';
            }

            if(strlen($Complication)>0){
                echo 'Complication : '.$Complication;
                echo '<br/>';
            }
