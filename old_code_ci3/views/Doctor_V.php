<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="javascript:load_form('/Doctor/search');"><i class="fa fa-dashboard"></i> Doctor List</a></li>
      ...
      <div class="row">
        <div class="col-md-9">
            <div class="jsError"></div>
             <?php 
                $attributes = array('id' => 'myform','role'=>'form','class'=>'form1');
                echo form_open('Doctor/AddNew',$attributes);  ?>
                        <div class="row">
                            <div class="col-md-2">
...
<script>
    $(document).ready(function(){
        $('#myform').on('submit', function(form){
            ...
            $("#Content1").html('Data Posting....Please Wait');
