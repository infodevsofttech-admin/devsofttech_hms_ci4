	...
	<div class="col-md-12">
		...
		<div class="box">
				...
				<?php echo form_open('Medical/NewPurchase', array('role'=>'form','class'=>'form1')); ?>
						...
						<div class="col-md-2">
							<div class="form-group">
								<label>Invoice /Challan ID</label>
								<input class="form-control input-sm" name="input_invoicecode" placeholder="Invoice No." type="text"   />
							</div>
						</div>
						<div class="col-md-2">
...
$(document).ready(function(){
	$('#btn_update').click(function(){
		$.post('/index.php/Storestock/CreatePurchase', $('form.form1').serialize(), function(data){
			if(data.insertid==0)
			{
			...
			}else
			{
				...
				load_form_div('Storestock/PurchaseInvoiceEdit/'+data.insertid,'searchresult');
			}
		}, 'json');
	});
});
