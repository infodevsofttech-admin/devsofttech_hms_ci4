...
<div class="box">
				...
				<div class="box-body">
				<?php echo form_open('Storestock/SupplierUpdate', array('role'=>'form','class'=>'form1')); ?>
					<?php
						$sid=0;
						$name_supplier="";
						$short_name="";
...
$(document).ready(function(){
	$('#btn_update').click(function(){
		$.post('/index.php/Storestock/SupplierUpdate', $('form.form1').serialize(), function(data){
			if(data.insertid==0)
			{
			...
			}else
			{
				...
				load_form_div('/Storestock/SupplierListSub','supplier_list');
				load_form_div('/Storestock/SupplierEdit/'+data.insertid,'test_div');
