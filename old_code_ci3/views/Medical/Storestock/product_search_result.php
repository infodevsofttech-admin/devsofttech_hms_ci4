		...
		<div id="supplier_list" class="box-body" style="height:500px;overflow-y:auto;">
		  <table id="report_list" class="table table-bordered table-striped TableData">
			...
			<tr>
				...
				<td>
					<button onclick="load_form_div('/Product_stock_master/Product_edit/<?=$product_list[$i]->id ?>','searchresult');" type="button" class="btn btn-warning">Edit</button>
					<button onclick="load_form_div('/Product_stock_master/Product_delete/<?=$product_list[$i]->id ?>','searchresult');" type="button" class="btn btn-warning">Delete</button>
				</td>
			</tr>
			<?php } ?>
			</tbody>
