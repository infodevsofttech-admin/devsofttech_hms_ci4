			...
			$('#btn_excel').click( function()
				{
					...
					var Get_Query="/Medical_backpanel/Stock_result_excel/"+ReOrder+"/"+item_name+"/"+schedule_id;
					alert(Get_Query);
			...
			$('#btn_excel_2').click( function()
				{
					...
					var Get_Query="/Medical_backpanel/Stock_result_excel_2/0/0/"+item_name+"/"+ReOrder+"/"+schedule_id;
					alert(Get_Query);
