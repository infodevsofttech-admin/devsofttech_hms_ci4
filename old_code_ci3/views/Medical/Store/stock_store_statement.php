			...
			$('#btn_excel').click( function()
				{
					...
					var Get_Query="/Medical_backpanel/store_Stock_result_datewise_excel/"+opd_date_range+"/"+item_name+"/"+supplier_id;
					
                    if(confirm(Get_Query))
                    {
                        window.open(Get_Query, "_blank");
                    }
            ...
            $('#btn_excel_3').click( function()
				{
					...
					var Get_Query="/Medical_backpanel/Stock_result_excel_3/"+supplier_id+"/"+opd_date_range+"/"+item_name+"/"+ReOrder;
					alert(Get_Query);
