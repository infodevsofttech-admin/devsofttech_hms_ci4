	...
	<div class="col-md-8">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-3">
					<div class="form-group">
					  <label for="cbo_cr_dr" class="col-sm-4 control-label">Type</label>
					   <div class="col-sm-8">
						  <select id="cbo_cr_dr" name="cbo_cr_dr" class="form-control">
						  	<option value="0" selected="selected"> Credit Amount </option>
	...
	<div class="col-md-4">
		...
		<table class="table table-striped ">
			...
			<?php foreach($payment_history as $row) { ?> 
					<tr>
						<td>
							<a href="/Medical_Print/ipd_cash_print_pdf/<?=$row->ipd_id?>/<?=$row->id?>" target="_blank" ><?=$row->id?></a>
						</td>
						<td>
							<?=$row->Payment_type_str?>
						</td>
						<td>
							<?=$row->str_payment_date?>
						</td>
						<td align="right">
							<?=$row->paid_amount?>
						</td>
