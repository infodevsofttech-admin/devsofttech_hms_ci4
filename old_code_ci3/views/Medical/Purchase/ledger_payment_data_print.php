...
<table style="font-size: 12px;width:100%;border-collapse: collapse;border-style:solid ;border-width:0.1mm;padding:3mm;" autosize="1">
    <thead>
        <tr>
            <th>Sr.No</th>
            <th>Date Tran</th>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $c->name_supplier.' / '.$c->mode_desc . ' ' . $c->tran_desc; ?></td>
