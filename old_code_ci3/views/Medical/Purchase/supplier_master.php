...
<div class="row">
	<div class="col-md-6">
		...
		<div class="box-header">
			...
			<div class="col-md-2">
				<button onclick="load_form_div('/Medical/SupplierEdit/0','test_div','Supplier : New Supplier :Pharma');" type="button" class="btn btn-primary">Add New</button></div>
		...
		<div id="supplier_list" class="box-body" style="height:500px;overflow-y:auto;">
		  <table id="report_list" class="table table-bordered table-striped TableData">
			...
			<tr>
			  ...
			  <td>
				  <button onclick="load_form_div('/Medical/SupplierEdit/<?=$supplier_data[$i]->sid ?>','test_div','Supplier :<?=$supplier_data[$i]->name_supplier ?>:Pharma');" type="button" class="btn btn-primary">Edit</button>
			  </td>
			</tr>
			<?php } ?>
			</tbody>
