...
<?php echo form_open('Patient/search', array('role'=>'form','class'=>'form2')); ?>
			<div class="input-group input-group-sm">
				<input class="form-control" type="text" id="txtsearch" name="txtsearch">
					...
					<span class="input-group-btn">
						<button onclick="load_form_div('/Medical/PurchaseNew','searchresult');" type="button" class="btn btn-warning btn-flat" >New Purchase/Challan Invoice</button>
					</span>
 ...
 <script>
	 $(document).ready(function(){
			$('form.form2').on('submit', function(form){
				...
				$.post('/index.php/Medical/PurchaseInvoice', $('form.form2').serialize(), function(data){
