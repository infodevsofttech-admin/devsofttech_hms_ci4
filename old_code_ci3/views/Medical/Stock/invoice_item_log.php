<section class="content-header">
    <h1>
        Medical Invoice Item Log  
        <small>Panel</small>
    </h1>
</section>
<section class="content">
    <?php echo form_open('Payment_Medical/payment_log_data', array('id' => 'form_payment_log','role'=>'form')); ?>
	<div class="row">
		<div class="col-md-3">
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
                ...
                $(document).ready(function(){
                    $('#form_payment_log').on('submit', function(form){
                        form.preventDefault();
                        form_array=$('#form_payment_log').serialize();
                        $("#show_report").html('Data Posting....Please Wait');
                        $.post('/index.php/Medical_backpanel/invoice_item_log_data', form_array, function(data){
