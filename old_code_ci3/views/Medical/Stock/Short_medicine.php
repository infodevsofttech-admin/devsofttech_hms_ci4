...
<section class="content">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<select class="form-control select2" id=schedule_id name="schedule_id[]" multiple="multiple" data-placeholder="Select a formulation, Blank for All"  >
				<?php foreach($med_formulation as $row){ ?>
					<option value="<?=$row->id ?>" ><?=$row->formulation_length ?></option>
				<?php } ?>
			</select>
		</div>
		<div class="col-md-3">
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				$('#showreport').click( function()
				{
					...
					var Get_Query="/Medical_Report/Short_medicine_data/"+$('#opd_date_range').val()+"/"+schedule_id+"/0";
				...
				$('#showreport_xls').click( function()
				{
					...
					var Get_Query="/Medical_Report/Short_medicine_data/"+$('#opd_date_range').val()+"/"+schedule_id+"/1";
