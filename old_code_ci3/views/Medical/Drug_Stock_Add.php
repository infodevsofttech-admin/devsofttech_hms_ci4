					...
					<div class="row">
						<div class="col-xs-3">
							...
							<label>Supplier</label>
								<select class="form-control input-sm" id="input_supplier" name="input_supplier"  >	
									...
									{ 
										echo '<option value='.$row->sid.'  '.combo_checked($row->sid,$drug_item[0]->supplier_id).'  >'.$row->name_supplier.'</option>';
									}
									?>
								</select>
							</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input class="form-control number" name="input_purchase_price" placeholder="Purchase Price" type="text" value="0"  />
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
