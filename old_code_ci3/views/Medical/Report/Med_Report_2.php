	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<div class="form-group">
				...
				<button type="button" class="btn btn-primary" id="showreport_short"  >Short</button>
			</div>
		</div>
	</div>
	<div class="row">
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				$('#showreport_short').click( function()
				{
					var Sdate = $("#datepicker_med_date").datepicker("getDate");
					var strDateTime =  Sdate.getFullYear() +'-'+ (Sdate.getMonth()+1) + "-" + Sdate.getDate() ;
					var input_type=$("#input_type").val();
										
					var Get_Query="/Medical_Report/Report_2_short_data/"+strDateTime+"/"+input_type+"/0";
					load_report_div(Get_Query,'show_report');
				});
