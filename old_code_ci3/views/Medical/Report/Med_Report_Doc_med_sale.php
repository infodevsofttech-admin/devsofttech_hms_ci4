	...
	<div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                <select name="input_doc_name" id="input_doc_name" class="form-control">
                    <?php 
                    foreach($doctor_master as $row)
                    {
                        echo '<option value="'.$row->p_fname.'"  >'.$row->p_fname.'</option>';
                    } 
                    ?>
                </select>
            </div>
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				{
                    var doc_name=encodeURI($('#input_doc_name').val());

					var Get_Query="/Medical_Report/Report_Doctor_Wise_sale_data/"+$('#opd_date_range').val()+"/"+doc_name+"/0";
				...
				$('#showreport_xls').click( function()
				{
					...
					var Get_Query="/Medical_Report/Report_Doctor_Wise_sale_data/"+$('#opd_date_range').val()+"/"+doc_name+"/1";
