...
<section class="content">
	<div class="row">
		...
		<div class="col-md-3">
			...
			<select class="form-control" name="cbo_billtype" id="cbo_billtype"  >
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				{
					var billtype=$('#cbo_billtype').val();
					var Get_Query="/Medical_Report/Report_IPD_Credit_data/"+$('#opd_date_range').val()+"/"+billtype;
				...
				{
					var billtype=$('#cbo_billtype').val();
					var Get_Query="/Medical_Report/Report_IPD_Credit_data/"+$('#opd_date_range').val()+"/"+billtype+"/1";
