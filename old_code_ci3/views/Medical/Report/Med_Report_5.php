    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <button type="button" class="btn btn-primary" id="showreport_xls">Invoice Excel</button>
            </div>
        </div>
        <div class="col-md-3">
            <label> </label>
...
$(document).ready(function() {
    ...
    $('#showreport').click(function() {
        var Get_Query = "/Medical_Report/Report_5_data/" + $('#opd_date_range').val();
        load_report_div(Get_Query, 'show_report');
        //load_form_div(Get_Query,'show_report');
    });

    $('#showreport_xls').click(function() {
        var Get_Query = "/Medical_Report/Report_5_data/" + $('#opd_date_range').val() + "/1";
    ...
    $('#showreport_hsn_xls').click(function() {
        var Get_Query = "/Medical_Report/Report_5_HSNdata/" + $('#opd_date_range').val() + "/1";
        window.open(Get_Query, "_blank");
    });
