<section class="content-header">
    <h1>
        Day OPD / Cash Invoice Pending Report 
        <small>Panel</small>
    </h1>
</section>
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<div class="form-group">
				<button type="button" class="btn btn-primary" id="showreport"  >Show Pending Balance</button>
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				{
					var Sdate = $('#opd_date_range').val();
					
										
					var Get_Query="/Medical_Report/Report_2_Bal_pending_data/"+Sdate+"/0";
				...
				$('#showreport_xls').click( function()
				{
					...
					var Get_Query="/Medical_Report/Report_2_Bal_pending_data/"+Sdate+"/1";
