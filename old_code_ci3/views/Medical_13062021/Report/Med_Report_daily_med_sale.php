...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				{
					var Get_Query="/Medical_Report/Report_daily_med_sale_data/"+$('#opd_date_range').val()+"/0";
					load_report_div(Get_Query,'show_report');
				});
				
				$('#showreport_xls').click( function()
				{
					var Get_Query="/Medical_Report/Report_daily_med_sale_data/"+$('#opd_date_range').val()+"/1";
