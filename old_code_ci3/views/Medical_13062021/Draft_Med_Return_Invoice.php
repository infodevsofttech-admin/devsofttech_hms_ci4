		...
		<div class="box">
			...
			<div class="box-footer">
				<a class="btn btn-app" href="javascript:load_form_div('/Medical/search_customer','maindiv');">
					<i class="fa fa-shopping-cart"></i>Serach Customer for Return Counter Sale
				</a>
				<a class="btn btn-app" href="javascript:load_form_div('/Medical/Invoice_Return_new/0/0/0','maindiv');">
					<i class="fa fa-shopping-cart"></i>New Return Counter Sale
				</a>
			</div>
		</div>
	</div>
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"Medical/getReturnInvoiceTable", // json datasource
						dataType: "json",
					...
					"columnDefs": [ 
					{
						...
						render: function ( data, type, row, meta ) {
							...
							if((row[8]>0 && row[10]>0) || (row[9]>0 && row[9]>11))
							{
								...
								url_link = "javascript:load_form_div('/Medical/final_invoice/"+ encodeURIComponent(row[7]) + "','maindiv');" ;
