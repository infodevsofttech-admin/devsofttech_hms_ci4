					...
					<div class="col-md-12">
						...
						<table class="table table-striped ">
							<tr>
								...
								<td>
									<a href="<?php echo '/Medical_Print/medicine_list_print_all/'.$ipd_master[0]->id.'/-1';  ?>" target="_blank" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Print Medicine List</a>
								</td>
								<td>
