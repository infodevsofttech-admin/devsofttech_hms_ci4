	...
	<div class="col-md-12">
		...
		<div class="box">
				...
				<div class="box-body">
					...
					<input type="hidden" id="related_drug_id" name="related_drug_id" value="<?=$product_data[0]->related_drug_id?>" >
					<div class="row">
						<div class="col-md-6"> 
					...
					<div class="row">
						<div class="col-md-4"> 
							<div class="form-group">
								<div class="ui-widget">
									...
									value="<?=$product_data[0]->item_name?>" >
								</div>
							</div>
						</div>
						<div class="col-md-6"> 
							<div class="form-group">
								<div class="ui-widget">
									...
									type="text" value="<?=$product_data[0]->genericname?>" >
								</div>
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								...
								<input class="form-control varchar input-sm" name="input_formulation" id="input_formulation" 
								placeholder="Tablet,Syrup,Capsule" type="text" value="<?=$product_data[0]->formulation?>"   />
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								...
								placeholder="10 Tablets in Strip,1 Bottle" type="text" value="<?=$product_data[0]->packing?>"  />
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								<label>Re-Order Qty</label>
								<input class="form-control number input-sm" name="input_re_order_qty" id="input_re_order_qty" placeholder="Re-Order Qty " 
								type="text" value="<?=$product_data[0]->re_order_qty?>"  />
							</div>
						</div>
						<?php 
							...
							$chk_schedule_h=$product_data[0]->schedule_h;
							if($chk_schedule_h==1)
							{
								$chk_schedule_h_checkbox_checked="checked";
							}else{
								$chk_schedule_h_checkbox_checked="";
							}

							$chk_schedule_h1=$product_data[0]->schedule_h1;
							if($chk_schedule_h1==1)
							{
								$chk_schedule_h1_checkbox_checked="checked";
							}else{
								$chk_schedule_h1_checkbox_checked="";
							}

							$chk_narcotic=$product_data[0]->narcotic;
							if($chk_narcotic==1)
							{
								$chk_narcotic_checkbox_checked="checked";
							}else{
								$chk_narcotic_checkbox_checked="";
							}

						?>
						<div class="col-md-2"> 
							<div class="form-group">
								<label><input id="chk_exp_date_applicable" name="chk_exp_date_applicable" type="checkbox"  <?=$chk_exp_date_applicable?>  >Exp.Date Applicable</label>
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								...
								type="text" value="<?=$product_data[0]->HSNCODE?>"   />
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								<label>CGST</label>
								<input class="form-control number input-sm" name="input_CGST" id="input_CGST" placeholder="CGST" 
								type="text" value="<?=$product_data[0]->CGST_per?>"  />
							</div>
						</div>
						...
						<div class="col-md-2"> 
							<div class="form-group">
								<label>SGST</label>
								<input class="form-control number input-sm" name="input_SGST" id="input_SGST" placeholder="SGST" 
								type="text" value="<?=$product_data[0]->SGST_per?>"  />
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								...
								type="text" value="<?=$product_data[0]->rack_no?>"  />
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								...
								type="text" value="<?=$product_data[0]->shelf_no?>"  />
							</div>
						</div>
						<div class="col-md-2"> 
							<div class="form-group">
								...
								type="text" value="<?=$product_data[0]->cold_storage?>"  />
							</div>
						</div>
						<div class="col-md-3">
							...
							<div class="form-group">
								<select name="input_company_name" id="input_company_name" class="form-control">
									...
									{
										$selected = ($company_master->id == $product_data[0]->company_id) ? ' selected="selected"' : "";

										echo '<option value="'.$company_master->id.'" '.$selected.'>'.$company_master->company_name.'</option>';
									} 
									?>
								</select>
							</div>
				...
				<div class="box-footer">
					<div class="row">
						<div class="col-md-2"> 
							<div class="form-group">
								<label> </label>
								<button type="button" class="btn btn-primary" id="btn_update_stock" accesskey="U" ><u>U</u>pdate Product in Master</button>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group">
								<label>
								<input id="chk_ban_flag_id" name="chk_ban_flag_id" type="checkbox"  <?=$chk_ban_flag_id_checkbox_checked?>  > 
								Banned Drug</label>
							</div>
							<div class="form-group">
								<label><input id="chk_batch_applicable" name="chk_batch_applicable" type="checkbox"  <?=$chk_batch_applicable_checkbox_checked?>  > Batch Applicable</label>
							</div>
							<div class="form-group">
								<label><input id="chk_is_continue" name="chk_is_continue" type="checkbox"  <?=$chk_is_continue_checkbox_checked?>  >Is Continue</label>
							</div>
							<div class="form-group">
								<label>
								<input id="chk_narcotic" name="chk_narcotic" type="checkbox" <?=$chk_narcotic_checkbox_checked?> > 
								Narcotic</label>
							</div>
							<div class="form-group">
								<label>
								<input id="chk_schedule_h" name="chk_schedule_h" type="checkbox" <?=$chk_schedule_h_checkbox_checked?> > 
								Schedule H</label>
							</div>
							<div class="form-group">
								<label>
								<input id="chk_schedule_h1" name="chk_schedule_h1" type="checkbox"  <?=$chk_schedule_h1_checkbox_checked?>> 
								Schedule H1</label>
							</div>
						</div>
						<!--- End --->	
   ...
   $(document).ready(function(){
	   var cache = {};
		...
		$("#input_drug").autocomplete({
			...
			$.getJSON( "/product_master/get_drug_master", {<?php echo $this->security->get_csrf_token_name(); ?>:'<?php echo $this->security->get_csrf_hash(); ?>','term':term}, function( data, status, xhr ) {
			  cache[ term ] = data;
			  response( data );
			});
		},
