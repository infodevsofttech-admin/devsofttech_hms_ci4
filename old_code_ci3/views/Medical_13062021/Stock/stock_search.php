...
<?php echo form_open('Patient/search', array('role'=>'form','class'=>'form2')); ?>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label><input id="chk_reorder" name="chk_reorder" type="checkbox"  checked  > ReOrder List</label>
				</div>
			</div>
			<div class="col-md-6">
 ...
 <script>
	 $(document).ready(function(){
			$('form.form2').on('submit', function(form){
				...
				$.post('/index.php/Medical_backpanel/Stock_qty_result', $('form.form2').serialize(), function(data){
			...
			$('#btn_excel').click( function()
				{
					...
					var Get_Query="/Medical_backpanel/Stock_result_excel/"+$('#input_supplier').val()+"/"+ReOrder+"/"+$('#txtsearch').val();
					alert(Get_Query);
