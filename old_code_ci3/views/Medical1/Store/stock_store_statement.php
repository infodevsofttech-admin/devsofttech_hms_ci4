...
<?php echo form_open('Patient/search', array('role'=>'form','class'=>'form2')); ?>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group input-group-sm">
                    ...
                    <span class="input-group-btn">
                        <button type="button" id="btn_excel" class="btn btn-info btn-flat">Items Excel</button>
                    </span>
                    <span class="input-group-btn">
                        <button type="button" id="btn_excel_2" class="btn btn-info btn-flat">Items Wise Excel</button>
                    </span>
            </div>
        </div>
<?php echo form_close(); ?>
    ...
    $(document).ready(function() {
        var start = moment();
            ...
            $('form.form2').on('submit', function(form){
				...
				$.post('/index.php/Medical_backpanel/store_Stock_result_datewise', $('form.form2').serialize(), function(data){
			...
			$('#btn_excel').click( function()
				{
                    ...
                    opd_date_range=$('#opd_date_range').val();
                    ...
                    var input_supplier=$('#input_supplier').val();
                    var opd_date_range=$('#opd_date_range').val();
					...
					var Get_Query="/Medical_backpanel/Stock_result_excel_2/"+input_supplier+"/"+opd_date_range+"/"+txtsearch+'/'+ReOrder;
					alert(Get_Query);
            ...
            $('#btn_excel_2').click( function()
				{
					...
					var Get_Query="/Medical_backpanel/Stock_result_excel_3/"+input_supplier+"/"+opd_date_range+"/"+txtsearch+'/'+ReOrder;
					alert(Get_Query);
