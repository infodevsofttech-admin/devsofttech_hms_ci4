						...
						<table class="table table-striped ">
							...
							$srno=1;
								...
								{ 
									...
									echo '<td>
									<a href="/Medical_print/invoice_print_single_bill/'.$row->id.'" target="_blank" class="btn btn-default">
										<i class="fa fa-print"></i> Print</a>
									<button type="button" class="btn btn-primary" onclick="edit_invoice('.$row->id.')">Edit</button></td>';
									$srno=$srno+1;
									echo '</tr>';
								}
...
<script>
	...
	function add_invoice(p_id,org_id){
		load_form_div('/Medical/Invoice_counter_new/'+p_id+'/0/'+org_id,'maindiv'); 
	}
