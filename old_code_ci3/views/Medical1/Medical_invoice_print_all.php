...
<head>
  ...
  <title><?=$pharmacyName?> | Invoice</title>
      ...
      <div class="row">
        ...
        <div class="col-xs-9">
		  ...
		  <p align="center"><?=$pharmacyAddress?><br>
            <?=$pharmacyPhone?>
            <br><b>GST: <?=$pharmacyGst?>   /  L.No: DEMO 1/USN/JUNE/2008 </b></p>
        </div>
        <!-- /.col -->
      </div>
	  <div class="row">
	 ...
	 <div class="row">
		<table class="table">
				<tr>
					...
					<th  align="center">CGST : <?=$inv_med_group[0]->CGST_Tamount?></th>
					<th  align="center">SGST : <?=$inv_med_group[0]->SGST_Tamount?></th>
					<th  align="center">Taxable Amount : <?=$inv_med_group[0]->TaxableAmount?></th>
