<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:load_form('/OcasePathLap/addPathTest/<?=$patient_master[0]->id ?>/<?=$invoice_master[0]->insurance_card_id ?>')">Edit</a></li>
...
<section class="invoice">
	...
	<div class="row no-print">
        <div class="col-xs-6">
          <a href="<?php echo '/OcasePathLap/invoice_print/'.$invoice_master[0]->id;  ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
        </div>
		<div class="col-xs-6">
...
$(document).ready(function(){
	...
	{
		$.post('/index.php/OcasePathLap/confirm_payment',
        ...
        if(data.update==0)
                ...
                }else
                {
					...
					load_form('/OcasePathLap/showinvoice/'+$('#invoice_id').val());
				}
		},'json');
	});
