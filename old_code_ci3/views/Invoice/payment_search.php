...
<?php echo form_open('Payment/payment_record', array('role'=>'form','class'=>'form_payment_search')); ?>
 ...
 <script>
	 $(document).ready(function(){
			$('form.form_payment_search').on('submit', function(form){
				form.preventDefault();
				$.post('/index.php/Payment/payment_record', $('form.form_payment_search').serialize(), function(data){
