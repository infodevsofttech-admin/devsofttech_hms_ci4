  ...
  <div class="row">
    <div class="col-xs-4">
      <div class="form-group">
        <label>Select Package Group</label>
    ...
    <div class="col-md-2">
      <div class="form-group">
        <button onclick="load_form_div('/Package/AddRecord','maindiv');" type="button" class="btn btn-primary">Add New Charge</button>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="box">
      ...
      <div class="box-body">
        <div id="search_div">
          <a href="/Package/search_print/1" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
          <a href="/Package/item_all_print?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print ALL</a>
          <br /><br />
          <table id="datashow1" class="table table-bordered table-striped TableData">
            ...
            <tbody>
              <?php foreach ($data as $row) { ?>
                <tr>
                  <td><?= $row->ipd_pakage_name ?></td>
                  <td><?= $row->Pakage_description ?></td>
                  <td><?= $row->Pakage_Min_Amount ?></td>
                  <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tallModal_item" data-testid="<?= $row->id ?>" data-testname="<?= $row->ipd_pakage_name ?>">Edit It....</button></td>
                </tr>
              <?php } ?>
            </tbody>
            <tfoot>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#package_group_id").change(function() {
      load_form_div('/Package/search_adv/' + $('#package_group_id').val(), 'search_div');
    });
    ...
    $('#tallModal_item').on('shown.bs.modal', function(event) {
      ...
      $.post('/index.php/Package/item_record/' + testid, {
        "test_id": testid,
