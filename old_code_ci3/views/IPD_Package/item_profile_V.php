                        ...
                        <div class="row">
							<div class="col-md-9">
								<div class="form-group">
									...
									<input class="form-control" name="input_Package_name" placeholder="Package Name" value="<?=$data_item[0]->ipd_pakage_name ?>" type="text" autocomplete="off">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Amount</label>
									<input class="form-control" name="input_Pakage_Min_Amount" placeholder="amount" value="<?=$data_item[0]->Pakage_Min_Amount ?>" type="text" autocomplete="off">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-8">
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" name="input_Pakage_description" placeholder="Enter ..."> <?=$data_item[0]->Pakage_description ?> </textarea>
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label>Amount</label>
							<input class="form-control number" id="input_amount_1" placeholder="amount" value="<?=$data_item[0]->Pakage_Min_Amount ?>" type="text" autocomplete="off">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
...
<script>
    $(document).ready(function(){
        $('#btn_update').click(function(){
			$.post('/index.php/Package/UpdateRecord', $('form.form1').serialize(), function(data){
                if(data.update==0)
                {
		...
		function add_item_spec()
		{
			...
			$.post('/index.php/Package/AddInsuranceItemRecord',
		...
		function remove_item_spec(item_id)
		{
			...
			$.post('/index.php/Package/remove_record_item',
