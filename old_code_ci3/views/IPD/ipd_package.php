					...
					<div class="panel-group" id="accordion">
						...
						<div class="panel panel-default">
							...
							<div id="collapse2" class="panel-collapse collapse">
							  <div class="panel-body">
									<div class="row">
										<div class="col-xs-12 show_lab_test">
											<div class="form-group">
											<label>Package Name</label>
												<select class="form-control input-sm" id="package_list_id" name="package_list_id"  >					
													<?php 
													foreach($package_list as $row)
													{ 
														echo '<option value='.$row->id.'>'.$row->ipd_pakage_name.'</option>';
													}
													?>
												</select>
											</div>
...
<script>
    $(document).ready(function(){
		...
		load_form_div('/Ipd/show_Package/'+ipd_id,'show_item_list');
	});
	...
	function add_package_manual()
	{
		...
		$.post('/index.php/Ipd/ipd_package_showitem/1',
	...
	function remove_item_invoice(itemid)
	{
		...
		{
			$.post('/index.php/Ipd/ipd_package_showitem/0',
			{ "itemid": itemid, 
	...
	function update_qty(itemid)
	{
		...
		if(confirm("Are you sure Update this item "))
		{
			...
			$.post('/index.php/Ipd/ipd_package_showitem/2',{ 
			"itemid": itemid, 
