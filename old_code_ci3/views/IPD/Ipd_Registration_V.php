            ...
            <div class="col-md-3">
			  ...
			  <div class="bootstrap-timepicker">
                <div class="form-group">
                  <label>Time:</label>
                  <div class="input-group">
                    <input id="res_time" name="res_time" class="form-control timepicker" type="text" >
                    <div  class="input-group-addon">
  ...
  $(document).ready(function(){
        $('form.form1').on('submit', function(form){
			...
			if(room_list=='' || room_list=='0' )
			{
				...
				$.post('/index.php/Ipd/AddNew', $('form.form1').serialize(), function(data){
					if(data.insertid==0)
					{
						$('div.jsError').html(data.error_text);
					}else
					{
						load_form('/Ipd/ipd_panel/'+data.insertid);
					}
				}, 'json');
			}
