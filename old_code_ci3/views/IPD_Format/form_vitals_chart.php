...
<h3 align="center">VITALS CHART</h3>
...
<table border="1" cellpadding="5" cellspacing="0" style="width:100%">
	<tbody>
		<tr>
			<td style="text-align:center; width:10%">SR.No.</td>
			<td style="text-align:center; width:10%">Date</td>
			<td style="text-align:center; width:10%">Time</td>
			<td style="text-align:center; width:10%">P. R.</td>
			<td style="text-align:center; width:10%">B.P.</td>
			<td style="text-align:center; width:10%">SPO2</td>
			<td style="text-align:center; width:10%">TEMP.</td>
			<td style="text-align:center; width:10%">RESP. RATE</td>
			<td style="text-align:center; width:10%">R.B.S</td>
			<td style="text-align:center; width:10%">SIGN.</td>
		</tr>
        <?php 
           for($i=1;$i<31;$i++){
        ?>
