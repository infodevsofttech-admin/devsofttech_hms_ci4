    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <select class="form-control" id="bank_id" name="bank_id">
                ...
                <?php
                foreach ($hospital_bank_payment_source as $row) {
                    echo '<option value=' . $row->ac_id . '  >' . $row->bank_name . ' : ' . $row->pay_type . '</option>';
                }
                ?>
            </select>
        </div>
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                <button type="button" class="btn btn-primary" id="showreport_export">Export</button>
            </div>
        </div>
    </div>
    <div class="row">
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        $('#showreport').click(function() {
            ...
            var Get_Query = "Report/report_total_payment_bank_show/" + $('#opd_date_range').val() +
                "/" + emp_list +
                "/" + $('#bank_id').val() ;
        ...
        $('#showreport_export').click(function() {
            var emp_list = $('#emp_name_id').val();
