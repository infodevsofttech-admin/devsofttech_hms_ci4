	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<div class="form-group">
					<button type="button" class="btn btn-primary" id="showreport"  >Show Short</button>
					<button type="button" class="btn btn-primary" id="showreport2"  >Export</button>
			</div>
		</div>
	</div>
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				{
					var Get_Query="Report/report_opd/"+$('#opd_date_range').val()+
					"/"+$('#doc_name_id').val()	;
