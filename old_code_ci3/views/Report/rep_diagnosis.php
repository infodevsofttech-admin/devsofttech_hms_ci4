...
<section class="content">
	<div class="row">
		...
		<div class="col-md-1">
			<label>Group</label>
			<select class="form-control select" id="doc_group_id" name="doc_group_id"   >
		...
		<div class="col-md-3">
			...
			<select class="form-control select2" id="doc_name_id" name="doc_name_id" multiple="multiple" data-placeholder="Select a diagnosis"  >
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				$('#showreport').click( function()
				{
					...
					var doc_group_id=$('#doc_group_id').val();
					
					
					var Get_Query="Report2/report_Diagnosis_total/"+$('#opd_date_range').val()+
					"/"+doc_name_id+
					"/"+diagnosis_id+
					"/"+doc_group_id;
