<section class="content-header">
    <h1>
        Report IPD Direct Customer Balance Pending Report
        <small>Panel</small>
    </h1>
</section>
...
<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				{
					var Get_Query="/Ipd_Report/Ipd_bal_panel_report/"+$('#opd_date_range').val()+"/0";
				...
				$('#showreportexport').click( function()
				{
					...
					var Get_Query="/Ipd_Report/Ipd_bal_panel_report/"+$('#opd_date_range').val()+"/1";
