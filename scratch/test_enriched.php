        ...
        "section": [
          ...
          },
          {
            ...
            "entry": [
              ...
              { "reference": "urn:uuid:8b4f1234-cva1-49ea-8822-222222222222", "display": "Cerebrovascular accident (CVA)" },
    ...
    },
    {
      ...
      "resource": {
        ...
        "code": {
          ...
          "text": "Cerebral vascular accident (CVA)"
        },
        "subject": {
          "reference": "urn:uuid:11cef8a6-4cd1-4733-afd0-92898eb57901",
          "display": "DEVENDER SINGH"
    ...
    },
    {
      ...
      "resource": {
        ...
        "code": {
          ...
          "text": "Lifestyle and Personal History: Alcohol"
        },
        "subject": {
          "reference": "urn:uuid:11cef8a6-4cd1-4733-afd0-92898eb57901",
          "display": "DEVENDER SINGH"
...
$bundle = json_decode($jsonText, true);
...
file_put_contents('d:/Workplace/HMS_CI4_OLD/scratch/validated_enriched_bundle.json', json_encode($bundle, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES));
echo "Saved scratch/validated_enriched_bundle.json (" . strlen(json_encode($bundle)) . " bytes)\n";
