...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Immunization">
      <sch:assert test="count(f:extension[@url = 'https://nrces.in/ndhm/fhir/r4/StructureDefinition/BrandName']) &lt;= 1">extension with URL = 'https://nrces.in/ndhm/fhir/r4/StructureDefinition/BrandName': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
