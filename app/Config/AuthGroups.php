...
class AuthGroups extends ShieldAuthGroups
{
    ...
    public array $permissions = [
        ...
        'reports.ipd_census.view' => 'Can view IPD census and discharge reports',
        'reports.ipd_surgery.view' => 'Can view IPD surgery reports',
    ...
    public array $matrix = [
        'superadmin' => [
            ...
            'reports.ipd_census.view',
            'reports.ipd_surgery.view',
            'finance.*',
            'diagnosis.*',
            'doctor_work.*',
            'pharmacy.*',
