...
$routes->group('setting', static function($routes) {
    ...
    $routes->get('admin/hospital-stock', 'Setting\\HospitalStock::index');
    $routes->get('admin/hospital-stock/dashboard', 'Setting\\HospitalStock::dashboard');
    $routes->get('admin/hospital-stock/masters', 'Setting\\HospitalStock::masters');
    $routes->get('admin/hospital-stock/indents', 'Setting\\HospitalStock::indents');
    $routes->get('admin/hospital-stock/purchase', 'Setting\\HospitalStock::purchase');
    $routes->get('admin/hospital-stock/reports', 'Setting\\HospitalStock::reports');
    $routes->post('admin/hospital-stock/category/save', 'Setting\\HospitalStock::saveCategory');
    $routes->post('admin/hospital-stock/category/update', 'Setting\\HospitalStock::updateCategory');
    $routes->post('admin/hospital-stock/category/delete', 'Setting\\HospitalStock::deleteCategory');
    $routes->post('admin/hospital-stock/item/save', 'Setting\\HospitalStock::saveItem');
    $routes->post('admin/hospital-stock/item/update', 'Setting\\HospitalStock::updateItem');
    $routes->post('admin/hospital-stock/item/delete', 'Setting\\HospitalStock::deleteItem');
    $routes->post('admin/hospital-stock/supplier/save', 'Setting\\HospitalStock::saveSupplier');
    $routes->post('admin/hospital-stock/supplier/update', 'Setting\\HospitalStock::updateSupplier');
    $routes->post('admin/hospital-stock/supplier/delete', 'Setting\\HospitalStock::deleteSupplier');
    $routes->post('admin/hospital-stock/indent/create', 'Setting\\HospitalStock::createIndent');
    $routes->post('admin/hospital-stock/indent/approve', 'Setting\\HospitalStock::approveIndent');
    $routes->post('admin/hospital-stock/indent/issue', 'Setting\\HospitalStock::issueIndent');
    $routes->post('admin/hospital-stock/po/create', 'Setting\\HospitalStock::createPurchaseOrder');
    $routes->post('admin/hospital-stock/po/receive', 'Setting\\HospitalStock::receivePurchaseOrder');
    $routes->get('admin/hospital-stock/report/department-consumption', 'Setting\\HospitalStock::reportDepartmentConsumption');
    $routes->get('admin/hospital-stock/report/monthly-issue', 'Setting\\HospitalStock::reportMonthlyIssue');
    $routes->get('admin/hospital-stock/report/near-expiry', 'Setting\\HospitalStock::reportNearExpiry');
