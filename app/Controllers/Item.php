...
class Item extends BaseController
{
    public function searchItemType(): string
    {
        ...
        return view('Setting/Charges/OPD_Charges/item_type_search_v', [
    ...
    public function searchAdv(int $itypeId = 1): string
    {
        ...
        return view('Setting/Charges/OPD_Charges/item_search_adv', [
    ...
    public function search(): string
    {
        ...
        return view('Setting/Charges/OPD_Charges/item_search_V', [
    ...
    public function searchPrint(int $itypeId = 1): string
    {
        ...
        return view('Setting/Charges/OPD_Charges/item_item_list', [
            'data' => $data,
    ...
    public function exportExcel(int $itypeId = 1)
    {
        ...
        $table = view('Setting/Charges/OPD_Charges/item_item_excel', [
            'data' => $data,
            'insuranceId' => $insuranceId,
            'insuranceName' => $insurance->ins_company_name ?? '',
        ]);

        $filename = 'OPD_Charges_' . date('dMy') . '.xls';
    ...
    public function itemTypeRecord(int $id): string
    {
        ...
        return view('Setting/Charges/OPD_Charges/item_type_profile', [
    ...
    public function itemRecord(int $id): string
    {
        ...
        return view('Setting/Charges/OPD_Charges/item_profile_V', [
    ...
    public function addRecord(): string
    {
        ...
        return view('Setting/Charges/OPD_Charges/item_create_V', [
            'data_item_type' => $model->getItemTypesList(),
        ]);
    }
    ...
    {
        return view('Setting/Charges/OPD_Charges/item_type_create');
    }
    ...
    public function addInsuranceItemRecord()
    {
        ...
        return $this->response->setJSON([
            'insertid' => $insertId,
            'error_text' => $insertId > 0 ? '' : 'Please Check',
            'html' => view('Setting/Charges/OPD_Charges/item_insurance_list', [
    ...
    public function createItemTypeRecord()
    {
        ...
        $model = new ItemModel();
        $data = [
            'is_ipd_opd' => $this->request->getPost('Item_Type_ipd'),
