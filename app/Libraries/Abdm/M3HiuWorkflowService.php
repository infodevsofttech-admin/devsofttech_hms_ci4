...
class M3HiuWorkflowService
{
    ...
    private function upsertWorkflow(
        ...
        $abdmConsentRequestId = $this->firstNonEmptyString([
            ...
            $result['consentRequestId'] ?? null,
            $result['consent']['consent_request_id'] ?? null,
            $result['consent']['consentRequestId'] ?? null,
            $result['consentDetail']['consent_request_id'] ?? null,
            $result['consentDetail']['consentRequestId'] ?? null,
            $result['data']['consent_request_id'] ?? null,
            $result['data']['consent']['consent_request_id'] ?? null,
            $payload['consentRequestId'] ?? null,
            $payload['consent_request_id'] ?? null,
            $payload['abdm_consent_request_id'] ?? null,
            $payload['consent']['consent_request_id'] ?? null,
            $payload['consentDetail']['consent_request_id'] ?? null,
        ]);
        ...
        $consentId = $this->firstNonEmptyString([
            ...
            $result['consent']['id'] ?? null,
            $result['consent']['consent_id'] ?? null,
            $result['consent']['consentId'] ?? null,
            $result['consentDetail']['id'] ?? null,
            $result['consentDetail']['consentId'] ?? null,
            $result['consentDetail']['consent_id'] ?? null,
            $result['consent_artifact_id'] ?? null,
            $result['consent_artefact_id'] ?? null,
            $result['data']['consent']['id'] ?? null,
            $result['data']['consent_id'] ?? null,
            $result['data']['consentId'] ?? null,
            $payload['abdm_consent_artifact_id'] ?? null,
            $payload['consent_id'] ?? null,
            $payload['consentId'] ?? null,
            $payload['consent']['id'] ?? null,
            $payload['consentDetail']['id'] ?? null,
