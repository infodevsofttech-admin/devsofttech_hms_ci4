...
window.AbhaCreateModal = (function () {
    ...
    function renderProfile(profile) {
        ...
        if (card) {
            ...
            $('#abhaCreateCardWrap').html('<img src="' + cardSrc + '" alt="Official ABHA card">');
            $('#abhaCreateDownloadCard').attr('href', cardSrc).removeClass('d-none');
        } else {
            $('#abhaCreateCardWrap').html('<div class="text-center text-muted"><i class="bi bi-card-image fs-1 d-block mb-2"></i><span>Official ABHA card was not returned by the Bridge.</span></div>');
