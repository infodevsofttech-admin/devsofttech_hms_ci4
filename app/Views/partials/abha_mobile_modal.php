                ...
                <section id="abhaMobileStep3" class="d-none">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <a class="btn btn-outline-primary w-100 mt-2 d-none" id="abhaMobileDownloadCard" download="ABHA-card"><i class="bi bi-download me-1"></i>Download ABHA Card</a>
                        </div>
                    </div>
...
window.AbhaMobileModal = (function () {
    ...
    function renderProfile(profile) {
        ...
        if (card) {
            ...
            var note = profile.card_source === 'abdm'
                ? ''
            ...
            $('#abhaMobileDownloadCard').attr('href', cardSrc).removeClass('d-none');
        } else {
            $('#abhaMobileCardWrap').html('<div class="text-center text-muted"><i class="bi bi-card-image fs-1 d-block mb-2"></i>Official ABHA card was not returned by the Bridge.</div>');
            $('#abhaMobileDownloadCard').addClass('d-none');
        }
        showStep(3);
    }
    ...
    return {
        open: function (prefillMobile, callback) {
            ...
            $('#abhaMobileOtp').val('');
            $('#abhaMobilePhoto,#abhaMobileDownloadCard').addClass('d-none');
            showStep(1);
            modal.show();
