...
window.AbhaVerifyModal = (function () {
    ...
    function renderProfile(profile) {
        ...
        if (card) {
            ...
            $('#abhaVerifyCardWrap').html('<img src="' + cardSrc + '" alt="Official ABHA card">');
            $('#abhaVerifyDownloadCard').attr('href', cardSrc).removeClass('d-none');
        } else {
            $('#abhaVerifyCardWrap').html('<div class="text-center text-muted"><i class="bi bi-card-image fs-1 d-block mb-2"></i>Official ABHA card was not returned by the Bridge.</div>');
