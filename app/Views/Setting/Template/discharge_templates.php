    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info py-2 small">
                ...
                <strong>2. Patient Information:</strong> <code>{{PATIENT_TITLE}}</code>, <code>{{PATIENT_NAME}}</code>, <code>{{UHID}}</code>, <code>{{IPD_CODE}}</code>, <code>{{AGE_GENDER}}</code>, <code>{{GUARDIAN}}</code>, <code>{{GUARDIAN_RELATION}}</code>, <code>{{GUARDIAN_NAME}}</code>, <code>{{PATIENT_ADDRESS}}</code>, <code>{{PATIENT_PHONE}}</code> ✨<br>
