...
<html>
<head>
    <title>OPD Packing List - <?= esc($packing->label_no) ?></title>
...
<body>
    <div class="container-fluid">
        ...
        <div class="header-section">
            <h4>OPD ORGANIZATION PACKING LIST</h4>
        ...
        <div class="info-box">
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <strong>Type:</strong> OPD Organization Cases
                </div>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <tfoot class="table-light">
                <tr>
                    <th colspan="7" class="text-end">Total Claim Amount:</th>
