...
<section class="content">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="bi bi-hospital me-2"></i>IPD TPA Cases Report
            </h5>
        ...
        <div class="card-body">
            <div class="row g-3 align-items-end">
                <div class="col-md-4">
                    <label class="form-label">Date Range (Admit/Register Date)</label>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" id="case_status" name="case_status">
                        ...
                        <option value="2">Submitted to Org.</option>
                    </select>
                </div>
                <div class="col-md-2">
...
<script>
    (function() {
        ...
        function buildQuery() {
            ...
            var caseStatus = document.getElementById('case_status').value || '-1';

            return '<?= base_url('Report/insurance_ipd_report_data') ?>/' 
                + encodeURIComponent(dateRange) + '/' + insuranceId + '/' + caseStatus;
        }
