<div class="pagetitle">
    <h1>Sale Day Report <small class="text-muted">Panel</small></h1>
</div>
...
(function () {
    ...
    function buildUrl(output) {
        ...
        return '<?= base_url('Medical_Report/Report_1_data') ?>/' +
            document.getElementById('inv_date_range').value + '/' + output;
    }
