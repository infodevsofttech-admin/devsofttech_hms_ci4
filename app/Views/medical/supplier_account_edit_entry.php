...
<form id="supplier-ledger-edit-form" class="row g-3" data-save-url="<?= base_url('Medical/supplier_account_edit_entry/' . $tranId) ?>">
    <input type="hidden" name="tran_id" value="<?= esc((string) $tranId) ?>">
    ...
    <div class="col-md-4">
        ...
        <input type="date" name="tran_date" class="form-control" value="<?= esc((string) ($old['tran_date'] ?? date('Y-m-d'))) ?>" required>
    </div>
