...
<div class="table-responsive">
    <table class="table table-bordered table-striped table-sm align-middle" id="daily-med-sale-table">
        <thead>
        <tr>
        ...
        <?php else: ?>
            <tr>
                <td colspan="11" class="text-center text-muted">No records found for selected date range.</td>
            </tr>
        <?php endif; ?>
        </tbody>
        <?php if (!empty($rows)): ?>
...
(function () {
    ...
    var tableId = '#daily-med-sale-table';
